...
- [[file:~/Repositories/nakama-godot-demo/godot/src/Main/GameWorld.gd::func _on_ServerConnection_chat_message_received(sender_id: String, message: String) -> void:][GameWorld._on_ServerConnection_chat_message_received()]]
